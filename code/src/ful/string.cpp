...
namespace
{
	...
	bool less_cstr_dispatch_init(const unit_utf8 * beg1, const unit_utf8 * end1, const unit_utf8 * beg2);
}
...
namespace ful
{
	namespace detail
	{
		...
		bool (* less_cstr_dispatch)(const unit_utf8 * beg1, const unit_utf8 * end1, const unit_utf8 * beg2) = less_cstr_dispatch_init;
	}
}
...
namespace
{
	...
	bool less_cstr_dispatch_init(const unit_utf8 * beg1, const unit_utf8 * end1, const unit_utf8 * beg2)
	{
		less_cstr_dispatch = cpuid_switch(
			cpuid_feature::AVX2, less_cstr_avx2,
			cpuid_feature::SSE2, less_cstr_sse2,
			less_cstr_none);
