...
namespace ful
{
	namespace detail
	{
		...
		// not and
		ful_target("bmi") ful_inline int andn(int x, int y) { return static_cast<int>(andn(static_cast<unsigned int>(x), static_cast<unsigned int>(y))); }

		// bit scan forward
		ful_inline unsigned int bsf(int x) { ful_expect(x != 0); return static_cast<unsigned int>(__bsfd(x)); }

		// bit scan forward
		ful_inline unsigned int bsf(unsigned int x) { return bsf(static_cast<int>(x)); }

		// bit scan reverse
		ful_inline unsigned int bsr(int x) { ful_expect(x != 0); return static_cast<unsigned int>(__bsrd(x)); }
		...
		// byte swap
		ful_inline short bswap(short x) { return static_cast<short>(bswap(static_cast<unsigned short>(x))); }

		// byte swap
		ful_inline int bswap(int x) { return __bswapd(x); }

		// byte swap
		ful_inline unsigned int bswap(unsigned int x) { return static_cast<unsigned int>(bswap(static_cast<int>(x))); }
		...
		// rotate left
		ful_inline int rotl(int x, int shift) { return static_cast<int>(rotl(static_cast<unsigned int>(x), shift)); }

		// rotate left
		ful_inline unsigned long rotl(unsigned long x, int shift) { return _lrotl(x, shift); }

		// rotate left
		ful_inline long rotl(long x, int shift) { return static_cast<long>(rotl(static_cast<unsigned long>(x), shift)); }

		// rotate right
		ful_inline unsigned int rotr(unsigned int x, int shift) { return __rord(x, shift); }

		// rotate right
		ful_inline int rotr(int x, int shift) { return static_cast<int>(rotr(static_cast<unsigned int>(x), shift)); }

		// rotate right
		ful_inline unsigned long rotr(unsigned long x, int shift) { return _lrotr(x, shift); }

		// rotate right
		ful_inline long rotr(long x, int shift) { return static_cast<long>(rotr(static_cast<unsigned long>(x), shift)); }
...
# if defined(__x86_64__)
		...
		// not and
		ful_target("bmi") ful_inline long long andn(long long x, long long y) { return static_cast<long long>(andn(static_cast<unsigned long long>(x), static_cast<unsigned long long>(y))); }

		// bit scan forward
		ful_inline unsigned int bsf(long long x) { ful_expect(x != 0); return static_cast<unsigned int>(__bsfq(x)); }

		// bit scan forward
		ful_inline unsigned int bsf(unsigned long long x) { return bsf(static_cast<long long>(x)); }

		// bit scan reverse
		ful_inline unsigned int bsr(long long x) { ful_expect(x != 0); return static_cast<unsigned int>(__bsrq(x)); }
		...
		// byte swap
		ful_inline unsigned long long bswap(unsigned long long x) { return static_cast<unsigned long long>(bswap(static_cast<long long>(x))); }
		...
		// rotate left
		ful_inline long long rotl(long long x, int shift) { return static_cast<long long>(rotl(static_cast<unsigned long long>(x), shift)); }

		// rotate right
		ful_inline unsigned long long rotr(unsigned long long x, int shift) { return __rorq(x, shift); }

		// rotate right
		ful_inline long long rotr(long long x, int shift) { return static_cast<long long>(rotr(static_cast<unsigned long long>(x), shift)); }
# endif
...
# if defined(__LP64__)
		...
		// not and
		ful_target("bmi") ful_inline long andn(long x, long y) { return static_cast<long>(andn(static_cast<unsigned long>(x), static_cast<unsigned long>(y))); }
		...
		// byte swap
		ful_inline unsigned long bswap(unsigned long x) { return static_cast<unsigned long>(bswap(static_cast<long>(x))); }
...
# endif
		...
		// move data after swapping bytes
		ful_target("movbe") ful_inline unsigned short loadbe(const unsigned short * x) { return static_cast<unsigned short>(loadbe(reinterpret_cast<const short *>(x))); }

		// move data after swapping bytes
		ful_target("movbe") ful_inline int loadbe(const int * x) { return _loadbe_i32(x); }

		// move data after swapping bytes
		ful_target("movbe") ful_inline unsigned int loadbe(const unsigned int * x) { return static_cast<unsigned int>(loadbe(reinterpret_cast<const int *>(x))); }
...
# if defined(_M_X64) || defined(_M_AMD64) || defined(__x86_64__)
		...
		// move data after swapping bytes
		ful_target("movbe") ful_inline unsigned long long loadbe(const unsigned long long * x) { return static_cast<unsigned long long>(loadbe(reinterpret_cast<const long long *>(x))); }
...
# endif
		...
		// move data after swapping bytes
		ful_target("movbe") ful_inline unsigned long loadbe(const unsigned long * x) { return static_cast<unsigned long>(loadbe(reinterpret_cast<const long *>(x))); }
		...
		// zero high bits starting with specified bit position
		ful_target("bmi2") ful_inline int bzhi(int x, unsigned int index) { return static_cast<int>(bzhi(static_cast<unsigned int>(x), index)); }
		...
		// parallel bits deposit
		ful_target("bmi2") ful_inline int pdep(int x, unsigned int mask) { return static_cast<int>(pdep(static_cast<unsigned int>(x), mask)); }

		// parallel bits extract
		ful_target("bmi2") ful_inline unsigned int pext(unsigned int x, unsigned int mask) { return _pext_u32(x, mask); }

		// parallel bits extract
		ful_target("bmi2") ful_inline int pext(int x, unsigned int mask) { return static_cast<int>(pext(static_cast<unsigned int>(x), mask)); }

		// return the count of number of bits set to 1
		ful_target("popcnt") ful_inline unsigned int popcnt(unsigned int x) { return static_cast<unsigned int>(_mm_popcnt_u32(x)); }
		...
		// zero high bits starting with specified bit position
		ful_target("bmi2") ful_inline long long bzhi(long long x, unsigned int index) { return static_cast<long long>(bzhi(static_cast<unsigned long long>(x), index)); }
		...
		// parallel bits deposit
		ful_target("bmi2") ful_inline long long pdep(long long x, unsigned long long mask) { return static_cast<long long>(pdep(static_cast<unsigned long long>(x), mask)); }

		// parallel bits extract
		ful_target("bmi2") ful_inline unsigned long long pext(unsigned long long x, unsigned long long mask) { return _pext_u64(x, mask); }

		// parallel bits extract
		ful_target("bmi2") ful_inline long long pext(long long x, unsigned long long mask) { return static_cast<long long>(pext(static_cast<unsigned long long>(x), mask)); }

		// return the count of number of bits set to 1
		ful_target("popcnt") ful_inline unsigned long long popcnt(unsigned long long x) { return static_cast<unsigned long long>(_mm_popcnt_u64(x)); }
		...
		// zero high bits starting with specified bit position
		ful_target("bmi2") ful_inline long bzhi(long x, unsigned int index) { return static_cast<long>(bzhi(static_cast<unsigned long>(x), index)); }
		...
		// parallel bits deposit
		ful_target("bmi2") ful_inline long pdep(long x, unsigned long mask) { return static_cast<long>(pdep(static_cast<unsigned long>(x), mask)); }
		...
		// parallel bits extract
		ful_target("bmi2") ful_inline long pext(long x, unsigned long mask) { return static_cast<long>(pext(static_cast<unsigned long>(x), mask)); }
